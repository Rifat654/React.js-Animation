                ...
                <div>
                    ...
                    <div className="first text-center lg:text-start">
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5 pt-5">
                            ...
                            <button className="px-2 py-1  border-2 hover:bg-green-700  rounded-md cursor-pointer hover:shadow-green-500 hover:text-amber-50 hover:border-green-600 transition-all duration-300">Learn more</button>
                        </div>
                    </div>
                </div>
            </div>
